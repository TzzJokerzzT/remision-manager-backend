...
function toSafeUser(user: { id: string; name: string; email: string; role: 'admin' | 'user'; companyLogoUrl?: string | null; isActive: boolean; createdAt: Date; updatedAt: Date }): SafeUser {
...
export class AuthUseCases {
  ...
  private async issueTokens(userId: string, role: 'admin' | 'user'): Promise<TokenPair> {
