...
import { createDriverSchema, updateDriverSchema } from '../../../application/dtos/driver.dto.js';
...
export function buildDriverRoutes(controller: DriverController): Router {
  ...
  router.patch('/:id', validate(idParamSchema, 'params'), validate(updateDriverSchema), controller.update);
