...
import { createClientSchema, updateClientSchema } from '../../../application/dtos/client.dto.js';
...
export function buildClientRoutes(controller: ClientController): Router {
  ...
  router.patch('/:id', validate(idParamSchema, 'params'), validate(updateClientSchema), controller.update);
